# 🧾 User Story: Generar snapshot OpenAPI
...
**As the** equipo  \n**I want** generar un snapshot OpenAPI del contrato  \n**So that** sirva de single source para clientes y tests de contrato
...
### Context Summary
Generación automatizada o manual desde Zod schemas.
