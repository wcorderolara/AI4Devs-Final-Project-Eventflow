# 🧾 User Story: CRUD de categorías con jerarquía 2 niveles
...
| ID                 | US-075                                  |
| Epic               | EPIC-ADM-001                                |
| Feature            | Gestión de ServiceCategory                             |
...
**As an** administrador  \n**I want** crear, editar y desactivar ServiceCategories con jerarquía máxima de 2 niveles (Decisión PO 8.1 #18)  \n**So that** el catálogo refleje servicios oficiales
...
### Context Summary
Jerarquía limitada; sin hard delete si está en uso.
...
### Dependencies
* Epic EPIC-ADM-001 dependencies.
...
| Use Case(s)            | UC-ADMIN-003                                 |
| Business Rule(s)       | BR-SERVICE-001..005                                 |
| Permission Rule(s)     | Según rol Admin                     |
| Data Entity / Entities | ServiceCategory                          |
| API Endpoint(s)        | POST/PATCH/DELETE /api/v1/admin/service-categories                          |
...
**Then** se produce el resultado esperado conforme a FR-ADMIN-002.
...
* Controller / Route: POST/PATCH/DELETE /api/v1/admin/service-categories
* Authorization Policy: Admin
* Validation: Zod
* Transaction Required: Sí

### Database
* Main Tables: ServiceCategory
...
| ------ | --------------------------------- | ------------------- |
| —      | POST/PATCH/DELETE /api/v1/admin/service-categories                         | Operación           |
