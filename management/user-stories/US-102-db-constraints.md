# 🧾 User Story: Validar constraints C-001..C-062
...
**As the** sistema  \n**I want** enforced los constraints del Doc 6 / Doc 18  \n**So that** la integridad de datos esté garantizada
...
### Context Summary
Constraints DB + chequeos app layer.
