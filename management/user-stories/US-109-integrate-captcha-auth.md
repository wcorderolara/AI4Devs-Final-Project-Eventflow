# 🧾 User Story: Integrar captcha en auth (registro y login)
...
**As the** sistema  \n**I want** integrar reCAPTCHA v3 / hCaptcha en registro y login (Decisión PO 8.1 #8)  \n**So that** prevengamos abuso por bots
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-AUTH-001..006                                |
| Use Case(s)            | UC-AUTH-001..003                                 |
| Business Rule(s)       | BR-AUTH-001..006                                 |
