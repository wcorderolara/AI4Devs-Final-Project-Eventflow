...
**As the** equipo IA  \n**I want** un catálogo de prompts y outputs IA reales (sanitizados) por feature  \n**So that** demostremos PromptOps responsable
...
### Context Summary
Anexar al reporte académico final.

### Related Domain Concepts
* AIPromptVersion, AIRecommendation
...
| Permission Rule(s)     | Según rol AI Engineer / PO                     |
...
### Database
* Main Tables: AIPromptVersion, AIRecommendation
* Constraints: N/A
