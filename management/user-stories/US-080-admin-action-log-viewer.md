# 🧾 User Story: Consultar log de AdminAction
...
**As an** administrador  \n**I want** consultar el log inmutable de AdminAction  \n**So that** revise auditoría completa de acciones admin
...
### Context Summary
Append-only; filtros por actor/target/tipo.
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-ADMIN-007                                |
| Use Case(s)            | UC-ADMIN-008                                 |
| Business Rule(s)       | BR-ADMIN-004                                 |
| Permission Rule(s)     | Según rol Admin                     |
| Data Entity / Entities | AdminAction                          |
...
**Then** se produce el resultado esperado conforme a FR-ADMIN-007.
...
* Controller / Route: GET /api/v1/admin/admin-actions
* Authorization Policy: Admin
* Validation: Zod
* Transaction Required: Sí

### Database
* Main Tables: AdminAction
...
| ------ | --------------------------------- | ------------------- |
| —      | GET /api/v1/admin/admin-actions                         | Operación           |
