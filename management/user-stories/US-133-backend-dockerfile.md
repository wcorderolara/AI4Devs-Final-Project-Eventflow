...
**As the** equipo  \n**I want** Dockerfile multi-stage para el backend  \n**So that** sea desplegable en AWS App Runner / Beanstalk
...
### Context Summary
Imagen optimizada y reproducible.
