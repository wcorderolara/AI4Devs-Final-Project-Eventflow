...
**As the** sistema backend  \n**I want** levantar Node + Express + TypeScript con Clean/Hex y feature-first folder structure  \n**So that** los módulos de dominio se desarrollen consistentemente
...
### Context Summary
Foundation del monolito modular MVP.
