# 🧾 User Story: Pipeline GitHub Actions (lint/test/build/deploy)
...
**As the** equipo  \n**I want** pipelines GitHub Actions con stages lint/typecheck/test/build/deploy  \n**So that** entreguemos consistentemente
