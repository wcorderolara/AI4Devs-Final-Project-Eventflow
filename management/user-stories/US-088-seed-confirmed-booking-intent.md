# 🧾 User Story: Seed incluye ≥1 BookingIntent confirmed_intent
...
| ID                 | US-088                                  |
| Epic               | EPIC-SEED-001                                |
| Feature            | BookingIntent confirmado en seed                             |
| Module / Domain    | Seed                              |
| User Role          | System                                |
| Priority           | Must Have                            |
| Status             | Draft                                |
...
**As the** sistema seed  \n**I want** incluir al menos un BookingIntent.confirmed_intent visible  \n**So that** la demo evidencie cierre del ciclo y permita reseñas
...
### Context Summary
Habilita US-065 (reseña verificada) en demo.
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-SEED-004                                |
| Use Case(s)            | UC-DEMO-001                                 |
| Business Rule(s)       | BR-SEED-006                                 |
...
**Then** se produce el resultado esperado conforme a FR-SEED-004.
