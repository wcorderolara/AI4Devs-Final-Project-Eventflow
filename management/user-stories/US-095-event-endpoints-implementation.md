# 🧾 User Story: Implementar endpoints EVENT
...
**As the** sistema  \n**I want** exponer endpoints EVENT  \n**So that** el frontend gestione eventos
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-EVENT-*                                |
| Use Case(s)            | UC-EVENT-*                                 |
| Business Rule(s)       | BR-EVENT-*                                 |
| Permission Rule(s)     | Según rol System                     |
| Data Entity / Entities | Event                          |
| API Endpoint(s)        | /api/v1/events/*                          |
...
* Controller / Route: /api/v1/events/*
