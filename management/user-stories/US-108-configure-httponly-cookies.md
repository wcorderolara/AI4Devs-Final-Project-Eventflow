...
**As the** sistema  \n**I want** emitir cookies con HttpOnly, Secure, SameSite=Lax, firmadas  \n**So that** las sesiones sean seguras y resistentes a XSS/CSRF
...
### Context Summary
Política de cookies del Doc 19.
...
| Data Entity / Entities | User session                          |
| API Endpoint(s)        | —                          |
