...
**As the** equipo QA  \n**I want** configurar el stack de testing (Vitest + Supertest + Playwright + MSW)  \n**So that** podamos cubrir unit/integration/E2E/contract
