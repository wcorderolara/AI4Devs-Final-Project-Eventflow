# 🧾 User Story: Propagar correlation ID por request
...
**As the** sistema  \n**I want** asignar y propagar correlation ID por cada request  \n**So that** rastreemos flujos completos en logs
...
### Context Summary
Header X-Correlation-Id + middleware.
