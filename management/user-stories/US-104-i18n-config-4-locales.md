# 🧾 User Story: Configurar i18n con 4 locales
...
**As the** sistema  \n**I want** configurar next-intl con es-LATAM, es-ES, pt, en  \n**So that** las rutas principales soporten 4 locales
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-I18N-*                                |
| Use Case(s)            | UC-I18N-*                                 |
| Business Rule(s)       | BR-I18N-*                                 |
