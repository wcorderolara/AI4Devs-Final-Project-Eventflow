# 🧾 User Story: Implementar MockAIProvider determinista
...
**As the** sistema  \n**I want** MockAIProvider con respuestas deterministas alineadas a seed  \n**So that** tests y demos sean reproducibles
...
### Context Summary
Fixtures de respuesta por feature IA.
...
| Business Rule(s)       | BR-AI-005, BR-AI-015                                 |
