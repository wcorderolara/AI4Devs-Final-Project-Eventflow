# 🧾 User Story: Listar eventos en solo lectura (admin)
...
| ID                 | US-078                                  |
| Epic               | EPIC-ADM-001                                |
| Feature            | Lectura de eventos por admin                             |
...
**As an** administrador  \n**I want** listar todos los eventos en modo solo lectura con auditoría  \n**So that** apoye soporte sin alterar datos (Decisión PO 8.1 #16)
...
### Context Summary
AdminAction(view_event) por cada lectura de detalle.
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-ADMIN-005                                |
| Use Case(s)            | UC-ADMIN-006                                 |
| Business Rule(s)       | BR-ADMIN-005                                 |
| Permission Rule(s)     | Según rol Admin                     |
| Data Entity / Entities | Event, AdminAction                          |
| API Endpoint(s)        | GET /api/v1/admin/events                          |
...
**Then** se produce el resultado esperado conforme a FR-ADMIN-005.
...
* Controller / Route: GET /api/v1/admin/events
* Authorization Policy: Admin
* Validation: Zod
* Transaction Required: Sí

### Database
* Main Tables: Event, AdminAction
...
| ------ | --------------------------------- | ------------------- |
| —      | GET /api/v1/admin/events                         | Operación           |
