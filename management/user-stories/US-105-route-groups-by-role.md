# 🧾 User Story: Route groups por rol
...
**As the** sistema frontend  \n**I want** route groups por (organizer)/(vendor)/(admin)  \n**So that** los layouts y guards sean por rol
