# 🧾 User Story: Configurar TanStack Query + MSW
...
**As the** sistema  \n**I want** configurar TanStack Query + MSW para fetching y mocking  \n**So that** los tests y dev experience sean robustos
