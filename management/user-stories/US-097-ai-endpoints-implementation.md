# 🧾 User Story: Implementar endpoints AI
...
**As the** sistema  \n**I want** exponer endpoints AI y AIRecommendation  \n**So that** las features IA del Doc 17 sean accesibles
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-AI-*                                |
| Use Case(s)            | UC-AI-*                                 |
| Business Rule(s)       | BR-AI-*                                 |
| Permission Rule(s)     | Según rol System                     |
| Data Entity / Entities | AIRecommendation                          |
| API Endpoint(s)        | /api/v1/events/:id/ai/*, /api/v1/ai-recommendations/*                          |
...
* Controller / Route: /api/v1/events/:id/ai/*, /api/v1/ai-recommendations/*
...
| ------ | --------------------------------- | ------------------- |
| —      | /api/v1/events/:id/ai/*, /api/v1/ai-recommendations/*                         | Capacidad           |
