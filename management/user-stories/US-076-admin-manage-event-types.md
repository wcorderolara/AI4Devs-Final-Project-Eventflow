# 🧾 User Story: Gestionar EventType con bloqueo de hard delete
...
**As an** administrador  \n**I want** gestionar EventTypes con bloqueo de hard delete si hay eventos asociados (Decisión PO 8.1 #17)  \n**So that** mantenga integridad referencial
...
### Context Summary
Soft delete o desactivar si hay eventos asociados.
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-ADMIN-003                                |
| Use Case(s)            | UC-ADMIN-004                                 |
| Business Rule(s)       | BR-EVENTTYPE-007, BR-EVENT-014                                 |
| Permission Rule(s)     | Según rol Admin                     |
| Data Entity / Entities | EventType                          |
| API Endpoint(s)        | POST/PATCH/DELETE /api/v1/admin/event-types                          |
...
**Then** se produce el resultado esperado conforme a FR-ADMIN-003.
...
* Controller / Route: POST/PATCH/DELETE /api/v1/admin/event-types
* Authorization Policy: Admin
* Validation: Zod
* Transaction Required: Sí

### Database
* Main Tables: EventType
...
| ------ | --------------------------------- | ------------------- |
| —      | POST/PATCH/DELETE /api/v1/admin/event-types                         | Operación           |
