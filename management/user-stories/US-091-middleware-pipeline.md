# 🧾 User Story: Pipeline de middlewares
...
**As the** sistema  \n**I want** una cadena de middlewares: correlation, logging, auth, role, ownership, validation, rate limit, captcha, upload, errorHandler  \n**So that** los endpoints sean seguros y observables por defecto
...
### Context Summary
Orden y composición de middlewares definidos.
