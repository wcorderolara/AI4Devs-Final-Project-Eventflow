# 🧾 User Story: Aplicar timeout 60s + fallback en demo (Decisión PO 8.1 #9)
...
**As the** sistema  \n**I want** aplicar timeout 60s y fallback a MockAIProvider en demo  \n**So that** la experiencia sea confiable
...
### Context Summary
AI_DEMO_MODE controla fallback.
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-AI-014, FR-AI-015                                |
| Use Case(s)            | —                                 |
