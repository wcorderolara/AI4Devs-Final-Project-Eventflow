# 🧾 User Story: Dashboard de métricas operativas
...
| ID                 | US-079                                  |
| Epic               | EPIC-ADM-001                                |
| Feature            | Métricas operativas admin                             |
...
**As an** administrador  \n**I want** ver un dashboard con métricas operativas (eventos, cotizaciones, vendors aprobados, reseñas, IA generations)  \n**So that** monitoree salud del sistema
...
### Context Summary
Sin métricas comerciales reales (sin revenue).

### Related Domain Concepts
* Event, Quote, VendorProfile, Review, AIRecommendation
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-ADMIN-006                                |
| Use Case(s)            | UC-ADMIN-007                                 |
| Business Rule(s)       | BR-ADMIN-007                                 |
| Permission Rule(s)     | Según rol Admin                     |
| Data Entity / Entities | Event, Quote, VendorProfile, Review, AIRecommendation                          |
...
**Then** se produce el resultado esperado conforme a FR-ADMIN-006.
...
* Controller / Route: GET /api/v1/admin/metrics
* Authorization Policy: Admin
* Validation: Zod
* Transaction Required: Sí

### Database
* Main Tables: Event, Quote, VendorProfile, Review, AIRecommendation
...
| ------ | --------------------------------- | ------------------- |
| —      | GET /api/v1/admin/metrics                         | Operación           |
