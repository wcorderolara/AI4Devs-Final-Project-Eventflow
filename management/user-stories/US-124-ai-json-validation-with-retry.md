# 🧾 User Story: Validación JSON estricta con reintento controlado
...
**As the** sistema  \n**I want** validar JSON IA con Zod y un único reintento controlado en fallo  \n**So that** los outputs sean confiables
...
### Context Summary
Un sólo retry; loggear si vuelve a fallar.
