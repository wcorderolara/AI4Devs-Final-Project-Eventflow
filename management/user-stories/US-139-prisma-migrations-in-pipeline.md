# 🧾 User Story: Migrations Prisma automáticas en pipeline
...
**As the** equipo  \n**I want** ejecutar prisma migrate deploy en pipeline  \n**So that** los entornos estén sincronizados
