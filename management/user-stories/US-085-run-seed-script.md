# 🧾 User Story: Ejecutar npm run seed reproducible
...
**As a** desarrollador o demo runner  \n**I want** ejecutar el script seed reproducible en un comando  \n**So that** carguemos datos LATAM coherentes y consistentes
...
### Context Summary
Idempotente; volúmenes mínimos definidos en Doc 11.

### Related Domain Concepts
* Todas las entidades con is_seed=true
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-SEED-001                                |
| Use Case(s)            | UC-DEMO-001                                 |
| Business Rule(s)       | BR-SEED-001..010                                 |
| Permission Rule(s)     | Según rol System / Developer                     |
| Data Entity / Entities | Todas las entidades con is_seed=true                          |
| API Endpoint(s)        | npm run seed                          |
...
**Given** contexto válido del actor System / Developer
**When** ejecuta la acción descrita
**Then** se produce el resultado esperado conforme a FR-SEED-001.
...
| ID     | Rule                                                                |
| ------ | ------------------------------------------------------------------- |
| SEC-01 | Sólo rol autorizado (System / Developer).                                         |
...
* Controller / Route: npm run seed
* Authorization Policy: Según rol
* Validation: Zod
* Transaction Required: Sí

### Database
* Main Tables: Todas las entidades con is_seed=true
...
| ID         | Scenario           | Expected Result |
| ---------- | ------------------ | --------------- |
| AUTH-TS-01 | System / Developer autorizado    | 200             |
