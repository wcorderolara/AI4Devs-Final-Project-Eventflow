# 🧾 User Story: Implementar endpoints QUOTE
...
**As the** sistema  \n**I want** exponer endpoints QUOTE / QR / BOOKING  \n**So that** los flujos bilaterales funcionen
...
* QuoteRequest, Quote, BookingIntent
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-QUOTE-*, FR-BOOKING-*                                |
| Use Case(s)            | UC-QUOTE-*, UC-BOOKING-*                                 |
| Business Rule(s)       | BR-QUOTE-*, BR-BOOKING-*                                 |
| Permission Rule(s)     | Según rol System                     |
| Data Entity / Entities | QuoteRequest, Quote, BookingIntent                          |
| API Endpoint(s)        | /api/v1/quote-requests/*, /api/v1/quotes/*, /api/v1/booking-intents/*                          |
...
* Controller / Route: /api/v1/quote-requests/*, /api/v1/quotes/*, /api/v1/booking-intents/*
* Authorization Policy: Aplica según endpoint
* Validation: Zod en boundary
* Transaction Required: Según operación

### Database
* Main Tables: QuoteRequest, Quote, BookingIntent
...
| ------ | --------------------------------- | ------------------- |
| —      | /api/v1/quote-requests/*, /api/v1/quotes/*, /api/v1/booking-intents/*                         | Capacidad           |
