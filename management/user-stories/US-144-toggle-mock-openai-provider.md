# 🧾 User Story: Configurar toggle Mock/OpenAI por env
...
| ID                 | US-144                                  |
| Epic               | EPIC-DEMO-001                                |
| Feature            | Toggle provider IA                             |
| Module / Domain    | Demo / AI                              |
| User Role          | System / Demo Operator                                |
| Priority           | Must Have                            |
| Status             | Draft                                |
...
**As the** operador demo  \n**I want** poder alternar entre OpenAI y Mock vía env var en Demo  \n**So that** la demo no dependa del provider externo
...
### Context Summary
Documentado en Doc 21 readiness.
...
| Business Rule(s)       | BR-AI-015                                 |
| Permission Rule(s)     | Según rol System / Demo Operator                     |
