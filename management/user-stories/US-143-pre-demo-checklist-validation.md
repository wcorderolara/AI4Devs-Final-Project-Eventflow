...
**As the** equipo  \n**I want** validar idioma, moneda, captcha, seeds, accesos antes de la demo  \n**So that** evitemos sorpresas durante la presentación
...
| Business Rule(s)       | —                                 |
| Permission Rule(s)     | Según rol Product Owner / Tech Lead                     |
