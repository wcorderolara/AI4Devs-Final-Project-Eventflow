# 🧾 User Story: Seed reset endpoint sólo Demo
...
**As an** admin Demo  \n**I want** endpoint seguro para reset surgical  \n**So that** las demos comiencen limpias
...
| Business Rule(s)       | —                                 |
| Permission Rule(s)     | Según rol System / Admin                     |
...
| ------ | --------------------------------- | ------------------- |
| —      | POST /api/v1/admin/seed/reset                         | Capacidad           |
