...
**As the** sistema  \n**I want** retornar errores con un sobre uniforme (code, message, details, correlationId)  \n**So that** el frontend pueda consumir consistentemente
...
### Context Summary
Definir esquema y aplicarlo en errorHandler.
