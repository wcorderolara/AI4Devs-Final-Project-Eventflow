# 🧾 User Story: Asegurar ≥1 BookingIntent.confirmed_intent visible en seed
...
| ID                 | US-145                                  |
| Epic               | EPIC-DEMO-001                                |
| Feature            | Seed visible para demo                             |
| Module / Domain    | Demo / Seed                              |
| User Role          | System                                |
| Priority           | Must Have                            |
| Status             | Draft                                |
...
**As the** sistema  \n**I want** garantizar BookingIntent confirmado visible para la demo  \n**So that** se pueda mostrar reseñas verificadas
