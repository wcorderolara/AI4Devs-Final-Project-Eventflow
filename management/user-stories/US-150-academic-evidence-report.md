# 🧾 User Story: Generar reporte de evidencia académica
...
**As the** Product Owner  \n**I want** un reporte que mapee épicas → US → métricas académicas (Doc 3 §15)  \n**So that** la rúbrica AI4Devs esté cubierta
...
| Use Case(s)            | —                                 |
| Business Rule(s)       | —                                 |
| Permission Rule(s)     | Según rol Product Owner                     |
