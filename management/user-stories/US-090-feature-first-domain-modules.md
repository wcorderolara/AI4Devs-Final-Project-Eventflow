# 🧾 User Story: Carpetas por módulo de dominio
...
**As the** sistema  \n**I want** organizar el backend por dominio (auth/events/ai/...) con capas Domain/Application/Interface/Ports/Infrastructure  \n**So that** la base de código sea mantenible y escalable
...
### Context Summary
Convención de carpetas aplicada en todos los módulos.
