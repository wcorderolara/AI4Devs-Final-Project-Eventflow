...
**As the** equipo  \n**I want** que cada US referencie sus FRD/UC/BR de origen  \n**So that** la trazabilidad sea verificable
...
### Context Summary
Cumplido en cada US del backlog.
...
| Use Case(s)            | —                                 |
| Business Rule(s)       | —                                 |
| Permission Rule(s)     | Según rol Product Owner / BA                     |
