# 🧾 User Story: Inicializar Next.js + dependencias
...
| ------------------ | ------------------------------------ |
| ID                 | US-103                                  |
| Epic               | EPIC-FE-001 — Frontend Next.js                                |
| Feature            | Bootstrap Next.js                             |
...
**As the** sistema frontend  \n**I want** levantar Next.js App Router + TS + TanStack Query + RHF + Zod + Tailwind + next-intl + MSW + Playwright  \n**So that** el stack frontend MVP esté listo
