# 🧾 User Story: Negative tests RBAC + ownership
...
| ID                 | US-112                                  |
| Epic               | EPIC-SEC-001                                |
| Feature            | Tests negativos seguridad                             |
...
**As the** equipo QA  \n**I want** suite negativa que asegure 403 / 404 en escenarios prohibidos  \n**So that** la seguridad esté garantizada por CI
