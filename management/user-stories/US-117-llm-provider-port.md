# 🧾 User Story: Implementar puerto LLMProvider
...
| ------------------ | ------------------------------------ |
| ID                 | US-117                                  |
| Epic               | EPIC-AI-001 — AI Architecture & PromptOps                                |
| Feature            | Puerto LLMProvider                             |
...
**As the** sistema  \n**I want** definir el puerto LLMProvider con contrato unificado  \n**So that** podamos swap entre OpenAI/Mock/Anthropic
...
### Context Summary
Hexagonal pattern; adapters intercambiables.
