...
**As the** equipo  \n**I want** suite E2E que ejerza el camino crítico (auth → event → IA → quote → booking → review)  \n**So that** demo readiness esté garantizado
...
### Context Summary
Sobre datos del seed reproducible.
