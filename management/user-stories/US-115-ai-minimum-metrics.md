# 🧾 User Story: Métricas mínimas de IA
...
**As the** sistema  \n**I want** registrar métricas de IA (latency, fallback_used, success_rate)  \n**So that** monitoreemos comportamiento IA
...
### Context Summary
Counters + histogramas (Prom Metrics format).
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-AI-019                                |
| Use Case(s)            | —                                 |
| Business Rule(s)       | BR-AI-007, BR-AI-010                                 |
