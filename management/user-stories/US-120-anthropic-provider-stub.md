# 🧾 User Story: Crear AnthropicProvider stub (Decisión PO 8.1 #15)
...
**As the** sistema  \n**I want** un stub de AnthropicProvider que cumpla el contrato sin implementación real  \n**So that** demuestre extensibilidad sin invertir en provider real (Future)
...
### Context Summary
Stub válido para arquitectura; flag por env var.
