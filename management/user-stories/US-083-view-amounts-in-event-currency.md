# 🧾 User Story: Ver cifras siempre en la moneda del evento
...
**As an** organizador  \n**I want** ver montos en la moneda fija de mi evento  \n**So that** no haya confusión con FX (sin conversión automática)
...
### Context Summary
Intl.NumberFormat por locale; moneda inmutable.
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-BUDGET-007, FR-BUDGET-009                                |
| Use Case(s)            | UC-I18N-002                                 |
| Business Rule(s)       | BR-BUDGET-006..010                                 |
| Permission Rule(s)     | Según rol Organizer                     |
| Data Entity / Entities | Event, Budget, Quote                          |
| API Endpoint(s)        | —                          |
...
**Then** se produce el resultado esperado conforme a FR-BUDGET-007, FR-BUDGET-009.
...
### Database
* Main Tables: Event, Budget, Quote
