# 🧾 User Story: Generar migrations base
...
**As the** sistema  \n**I want** generar migrations versionadas reproducibles  \n**So that** los entornos se mantengan sincronizados
