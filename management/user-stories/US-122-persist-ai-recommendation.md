# 🧾 User Story: Persistir AIRecommendation con metadata
...
**As the** sistema  \n**I want** persistir cada sugerencia IA con prompt_version, provider, language, fallback_used, latency  \n**So that** la trazabilidad académica e industrial sea completa
...
### Context Summary
Status: pending/accepted/edited/rejected/discarded.
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-AI-009                                |
| Use Case(s)            | UC-AI-009                                 |
| Business Rule(s)       | BR-AI-008                                 |
