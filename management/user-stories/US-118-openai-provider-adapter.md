# 🧾 User Story: Implementar OpenAIProvider
...
**As the** sistema  \n**I want** OpenAI adapter como provider principal MVP  \n**So that** features IA funcionen en producción
...
### Context Summary
Manejo de errores y timeout 60s.
