# 🧾 User Story: Admin reset del entorno Demo
...
**As an** admin del entorno Demo  \n**I want** resetear el entorno con un endpoint surgical  \n**So that** las demos comiencen limpias
...
### Context Summary
Sólo disponible en entorno Demo.

### Related Domain Concepts
* Entidades is_seed=true
...
| Source                 | Reference                          |
| ---------------------- | ---------------------------------- |
| FRD Requirement(s)     | FR-SEED-002, FR-DEMO-001                                |
| Use Case(s)            | UC-DEMO-001                                 |
| Business Rule(s)       | BR-SEED-009                                 |
| Permission Rule(s)     | Según rol Admin / System                     |
| Data Entity / Entities | Entidades is_seed=true                          |
| API Endpoint(s)        | POST /api/v1/admin/seed/reset                          |
...
**Given** contexto válido del actor Admin / System
**When** ejecuta la acción descrita
**Then** se produce el resultado esperado conforme a FR-SEED-002, FR-DEMO-001.
...
| ID     | Rule                                                                |
| ------ | ------------------------------------------------------------------- |
| SEC-01 | Sólo rol autorizado (Admin / System).                                         |
...
* Controller / Route: POST /api/v1/admin/seed/reset
* Authorization Policy: Según rol
* Validation: Zod
* Transaction Required: Sí

### Database
* Main Tables: Entidades is_seed=true
...
| ------ | --------------------------------- | ------------------- |
| —      | POST /api/v1/admin/seed/reset                         | Operación           |
...
| ID         | Scenario           | Expected Result |
| ---------- | ------------------ | --------------- |
| AUTH-TS-01 | Admin / System autorizado    | 200             |
