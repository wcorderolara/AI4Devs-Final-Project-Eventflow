# 🧾 User Story: Implementar índices críticos
...
**As the** sistema  \n**I want** crear índices críticos para consultas frecuentes  \n**So that** el performance sea aceptable
...
### Context Summary
Por owner, status, due_date, vendor_id, etc.
