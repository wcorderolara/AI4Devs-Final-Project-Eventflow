---
name: eventflow-po-ba-decision-resolver
description: Resolve pending Product Owner and Business Analyst decisions raised during EventFlow user story refinement, update the user story when safe, and create the formal decision-resolution artifact. Use when a refinement review contains blockers, pending questions, scope conflicts, traceability gaps, or documentation alignment decisions.
---
