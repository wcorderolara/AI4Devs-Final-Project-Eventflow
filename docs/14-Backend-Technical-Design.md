...
- **Repository ports:** `NotificationRepository` (generic), `NotificationT7Repository` (US-034 T-7), `NotificationQrReceivedRepository` (US-068), `NotificationQuoteReceivedRepository` (US-069), `NotificationBookingConfirmedRepository` (US-070), `ListNotificationsRepository` (US-071).
